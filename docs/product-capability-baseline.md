...
| PLAT-006 | Organizations, workspaces and site administration | V6 | `complete` | Multiple isolated organizations/workspaces with global and workspace admins |
| PLAT-007 | Groups, directories and reusable role assignments | V6 | `complete` | Users and groups can be assigned consistently across workspaces and projects |
